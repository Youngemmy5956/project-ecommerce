...
<!-- Mirrored from htmlbigstart.justthemevalley.com/Version1/compare.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 May 2022 02:31:53 GMT -->
<head>
<!-- Basic page needs -->
<meta charset="utf-8">
<!--[if IE]>
            ...
            <table class="table compare-table">
              ...
              <tbody>
                <tr class="product-shop-row first odd">
                  <th>&nbsp;</th>
                  <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a> <a class="product-image" href="#" title=" Product Title Here "><img src="images/products/img01.jpg" alt=" Product Title Here " width="200"></a>
                    <h2 class="product-name"><a href="#" title=" Product Title Here "> Product Title Here </a></h2>
                    
                  
                    </td>
                    <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a> <a class="product-image" href="#" title=" Product Title Here "><img src="images/products/img02.jpg" alt=" Product Title Here " width="200"></a>
                    <h2 class="product-name"><a href="#" title=" Product Title Here "> Product Title Here </a></h2>
                    </td>
                    <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a> <a class="product-image" href="#" title=" Product Title Here "><img src="images/products/img03.jpg" alt=" Product Title Here " width="200"></a>
                    <h2 class="product-name"><a href="#" title=" Product Title Here "> Product Title Here </a></h2>
                    </td>
                  <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a><a class="product-image" href="#" title="Product Title Here"><img src="images/products/img04.jpg" alt=" Product Title Here " width="200"></a>
                    <h2 class="product-name"><a href="#" title="Product Title Here">Product Title Here</a></h2>
                    </td>
                </tr>
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <p> <i class="fa fa-envelope"></i><span><a href="https://htmlbigstart.justthemevalley.com/cdn-cgi/l/email-protection#dabfb7bbb3b69abeb5b7bbb3b4f4b9b5b7"><span class="__cf_email__" data-cfemail="6c1f191c1c031e182c18040901091f420f0301">[email&#160;protected]</span></a></span></p>
          </address>
        </div>
      </div>
    </div>
